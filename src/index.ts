import { BenchmarkResult, runBenchmark } from "./benchmark/index.js";
import { assignPoints, resultsSorter } from "./benchmark/utils.js";
import * as Solvers from "./solvers/index.js";

// CHANGE these constants to limit test executions to just some specific levels and to output detailed results
const MIN_LEVEL = 1;
const MAX_LEVEL = 1;
